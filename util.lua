...
if core.get_translator then
	contraptions_mod.S = core.get_translator(core.get_current_modname())
else
...
function contraptions_mod.fs_helpers.cycling_button(meta, base, meta_name, values)
	...
	local field = "fs_helpers_cycling:"..new_value..":"..meta_name..";"..core.formspec_escape(text)
...
function contraptions_mod.get_objects_with_square_radius(pos, rad)
  rad = rad + 0.5
  local objs = {}
  for _,object in ipairs(core.env:get_objects_inside_radius(pos, math.sqrt(3)*rad)) do
