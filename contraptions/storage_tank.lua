...
contraptions_mod.registered_storage_tanks = {}
...
minetest.register_node(":factory:storage_tank", {
	...
	on_rightclick = function(pos, _, clicker, itemstack)
		...
		for n,d in pairs(contraptions_mod.registered_storage_tanks) do
...
function contraptions_mod.register_storage_tank(name, increment, tiles, plaintile, light, bucket_full, bucket_empty)
	contraptions_mod.registered_storage_tanks[name] = {
		increment = increment,
...
contraptions_mod.register_storage_tank("water", 4,
	{{name="default_water_source_animated.png", animation={type="vertical_frames", aspect_w=16, aspect_h=16, length=2.0}}},
	"default_water.png", 0, "bucket:bucket_water", "bucket:bucket_empty")
contraptions_mod.register_storage_tank("lava", 8,
